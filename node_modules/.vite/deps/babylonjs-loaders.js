          ...
          var __webpack_modules__ = {
                ...
                var SPLATFileLoader = (
                  ...
                  function() {
                    ...
                    SPLATFileLoader2.prototype._parse = function(meshesNames, scene, data, rootUrl) {
                      var babylonMeshesArray = [];
                      var parsedPLY = SPLATFileLoader2._ConvertPLYToSplat(data);
                      switch (parsedPLY.mode) {
                        case 0:
                          {
                            var gaussianSplatting = new babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__.GaussianSplattingMesh("GaussianSplatting", null, scene, this._loadingOptions.keepInRam);
                        ...
                        case 1:
                          {
                            var pointcloud = new babylonjs_Loading_sceneLoader__WEBPACK_IMPORTED_MODULE_0__.PointsCloudSystem("PointCloud", 1, scene);
                            if (SPLATFileLoader2._BuildPointCloud(pointcloud, parsedPLY.data)) {
                              return Promise.all([pointcloud.buildMeshAsync()]).then(function(mesh) {
                    ...
                    SPLATFileLoader2._ConvertPLYToSplat = function(data) {
                      ...
                      for (var _i = 0, filtered_1 = filtered; _i < filtered_1.length; _i++) {
                        ...
                        var type = (_a = prop.split(" "), _a[1]), name_1 = _a[2];
                      ...
                      var faces = [];
                      if (faceCount) {
                        var offset = rowOffset * vertexCount;
                      ...
                      return { mode: currentMode, data: buffer, faces, hasVertexColors: !!propertyColorCount };
                    };
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_animation_pointer.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var _KHR_animation_pointer_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__2(
                  /*! ./KHR_animation_pointer.data */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_animation_pointer.data.ts"
                );
                var _gltfPathToObjectConverter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__2(
                  /*! ./gltfPathToObjectConverter */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/gltfPathToObjectConverter.ts"
                );
                var _glTFLoaderExtensionRegistry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__2(
                  /*! ../glTFLoaderExtensionRegistry */
                  "../../../dev/loaders/src/glTF/2.0/glTFLoaderExtensionRegistry.ts"
                );
                ...
                (0, _glTFLoaderExtensionRegistry__WEBPACK_IMPORTED_MODULE_3__.registerGLTFExtension)(NAME, true, function(loader) {
            ...
            "../../../dev/loaders/src/glTF/2.0/Extensions/KHR_interactivity.ts": (
              ...
              (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
                ...
                var _interactivityFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__2(
                  /*! ./interactivityFunctions */
                  "../../../dev/loaders/src/glTF/2.0/Extensions/interactivityFunctions.ts"
                );
                var _interactivityPathToObjectConverter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__2(
                ...
                var KHR_interactivity = (
                  ...
                  function() {
                    ...
                    KHR_interactivity2.prototype.onReady = function() {
                      ...
                      var coordinator = new babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_0__.FlowGraphCoordinator({ scene });
                      babylonjs_FlowGraph_flowGraphCoordinator__WEBPACK_IMPORTED_MODULE_0__.FlowGraph.Parse(json, { coordinator, pathConverter: this._pathConverter });
                      coordinator.start();
                    };
                ...
                var GLTFLoader = (
                  ...
                  function() {
                          ...
                          switch (_g.label) {
                            case 0:
                              ...
                              _glTFLoaderExtensionRegistry__WEBPACK_IMPORTED_MODULE_3__.registeredGLTFExtensions.forEach(function(registeredExtension, name) {
                                var _a2;
                                if (((_a2 = _this.parent.extensionOptions[name]) === null || _a2 === void 0 ? void 0 : _a2.enabled) === false) {
                            ...
                            case 1:
                              ...
                              if (this._gltf.extensionsRequired) {
                                _loop_1 = function(name_12) {
                                  ...
                                  if (!available) {
                                    if (((_a = this_1.parent.extensionOptions[name_12]) === null || _a === void 0 ? void 0 : _a.enabled) === false) {
                    ...
                    GLTFLoader2.prototype._loadAnimationChannelAsync = function(context, animationContext, animation, channel, onLoad) {
                      ...
                      var pathIsWeights = channelTargetPath === "weights";
            ...
            "../../../../node_modules/tslib/tslib.es6.mjs": (
              ...
              (__unused_webpack___webpack_module__, __webpack_exports__2, __webpack_require__2) => {
                ...
                __webpack_require__2.d(__webpack_exports__2, {
                  ...
                  /* harmony export */
                  "default": () => __WEBPACK_DEFAULT_EXPORT__2
                  /* harmony export */
                });
                ...
                const __WEBPACK_DEFAULT_EXPORT__2 = {
                  __extends,
                  __assign,
                  __rest,
                  __decorate,
